...
df['label'].replace(Attack,'Attack',inplace=True)
...
np.save('./results/history/CNN_Binary_classification_history.npy', history.history)
np.save('./history/CNN_Binary_classification_Fitting_time.npy', np.array([[start_fit, end_fit, fit_time]]))
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('./results/figures/CNN_Binary_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./results/figures/CNN_Binary_classification_loss.eps', format='eps', dpi=1200)
plt.show()
...
np.save('./results/history/CNN_Binary_classification_Inference_time.npy', np.array([[start_time, end_time, inference_time]]))
...
# Save the model
model_save_path = os.path.join(output_dir, 'cnn_binary_model.keras')
